...
public class SendEmailReportSeleniumDemo {
	...
	public static void main(String[] args) throws MessagingException {
		...
		//Recipient's Mail id
		String receipientTo = "bpapugari@gmail.com";
		
		//Sender's Mail id
		String senderFrom = "babugari@gmail.com";
		
		//Path of PDF test report
		String path = "F:\\CucumberFramework\\target\\cucumber-reports\\report.html";
		...
		transport.connect("smtp.gmail.com",465,"babugari@gmail.com","lxjadecbxrmzyhbh");
